...
const handleMouseMove = (event) => {
  ...
  // Move the handle.
  handle.style.left = `${event.clientX + window.innerWidth / 3.85 + delta}px`
...
<template>
  ...
  <!-- 底層原圖 -->
    <div class="absolute w-full min-h-[45vw] overflow-hidden bg-gray-800 z-10 panel bottom">
  ...
  <!-- 上層覆蓋 -->
    <div ref="topPanelRef" class="absolute w-full min-h-[45vw] overflow-hidden bg-indigo-700 z-20 panel top -skew-x-[30deg] -ml-[1000px] w-[calc(50vw+1000px)]">
